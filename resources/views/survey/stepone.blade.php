            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg w-100 text-sm">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex justify-end my-6 mx-4 gap-x-1">
                        <a href="{{route('viewSurvey',['Id'=>$survey->id])}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Previous
                        </a>
                        <a href="{{route('viewSurveySteptwo',['Id'=>$survey->id , 'part' => 'Part III'])}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Next
                        </a>
                    </div>
                </div>
