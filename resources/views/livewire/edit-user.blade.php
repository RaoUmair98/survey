                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            wire:model="user.name" type="text" placeholder="Name">
                        @error('user.name')
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            wire:model="user.email" type="text" placeholder="Email">
                        @error('user.email')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <select wire:model="user.role_id" wire:change="openDiv($event.target.value)"
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="role">
                        ...
                        <div class="mb-4">
                            ...
                            <select wire:model="user.manager_id"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="reportsto">
