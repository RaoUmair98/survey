                ...
                <a href="{{ route('addUser') }}"
                    ...
                    <svg class="h-5 w-5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                        ...
                        <path fill-rule="evenodd"
                            d="M5 3a1 1 0 011-1h8a1 1 0 011 1v2h3a1 1 0 011 1v12a1 1 0 01-1 1H6a1 1 0 01-1-1V6a1 1 0 011-1h3V3zm5 2H6v12h9V5h-3zM8 8a1 1 0 011-1h2a1 1 0 010 2H9a1 0 01-1-1zm0 4a1 1 0 011-1h2a1 0 010 2H9a1 0 01-1-1z"
                            clip-rule="evenodd" />
                    </svg>
                    Create Survey
                </a>
                            ...
                            <div class="flex">
                                <div class="flex-shrink-0">
                                    <svg class="h-5 w-5 text-green-400" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path fill-rule="evenodd"
                                            d="M10 18a8 8 0 100-16 8 8 0 000 16zM5 9a1 1 0 011-1h1.6a1 1 0 01.7.3l3.3 3.4 2.7-2.7a1 1 0 111.4 1.4l-3 3a1 0 01-1.4 0l-4-4a1 0 010-1.4l1.5-1.5a1 1 0 011.4 0H14a1 0 010 2H7a1 0 01-1-1V9z"
                                            clip-rule="evenodd" />
                                    </svg>
                                </div>
                                <div class="ml-3">
                            ...
                            <div class="flex">
                                <div class="flex-shrink-0">
                                    <svg class="h-5 w-5 text-red-400" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                        <path fill-rule="evenodd"
                                            d="M10 18a8 8 0 100-16 8 8 0 000 16zM5.293 6.707a1 1 0 011.414 0L10 10.586l3.293-3.293a1 0 111.414 1.414L11.414 12l3.293 3.293a1 0 01-1.414 1.414L10 13.414l-3.293 3.293a1 0 01-1.414-1.414L8.586 12 5.293 8.707a1 0 010-1.414z"
                                            clip-rule="evenodd" />
                                    </svg>
                                </div>
                                <div class="ml-3">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @foreach ($usersurveys as $usersurvey)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $names[$usersurvey->user_id]}}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="min-w-[10rem] h-4 bg-gray-200 rounded-full">
                                            <div class="h-full text-center text-xs text-white {{ $managerpercentage[0] == 53 ? 'bg-red-500' : 'bg-green-500' }} rounded-full"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @if(Auth::user()->role->role_id >= 2)
                                            <a type="button"
                                                href="{{ '/survey/'.$usersurvey->user->name.'/'.$usersurvey->user->id.'/employee_progress' }}"
